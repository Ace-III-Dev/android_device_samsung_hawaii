...
TARGET_KERNEL_CONFIG := bcm21664_hawaii_ss_logan_rev03_deconfig
...
BOARD_EGL_CFG := device/samsung/hawaii/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/hawaii/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/hawaii/libbt_vndcfg.txt
